...
import { getAdminNotifikasi, type NotifItem } from "@/app/actions/notifikasi";
...
export default function AdminNotifikasiPage() {
  ...
  useEffect(() => {
    async function load() {
      const { data } = await getAdminNotifikasi();
      setItems(data);
      setReady(true);
    }
    load();
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-gray-500">Iuran dan pengajuan izin/cuti yang menunggu tindakan</p>
      </div>
