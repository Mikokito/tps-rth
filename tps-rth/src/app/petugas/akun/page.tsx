...
import { User, Phone, MapPin, Briefcase, Check, AlertCircle, Camera } from "lucide-react";
import { getSession, updateProfile as saveProfile, type SessionUser } from "@/lib/mockAuth";
            ...
            <div className="relative">
              <div className="w-24 h-24 rounded-full bg-[#2F855A] flex items-center justify-center overflow-hidden ring-4 ring-green-100">
                {avatar
                  ...
                  : <span className="text-3xl font-bold text-white">{session?.nama?.[0] ?? "P"}</span>
                }
              </div>
